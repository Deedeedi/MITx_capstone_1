...
$\mathbb{E}[Y] = \sum_n{p_{N}(n)\mathbb{E}[Y|N=n]}$\\
...
Variance of sum of n \textbf{dependent} r.v.:\\

$Var(X_{1}+X_{2}+...+X_{n})=\sum_{i=1}^{n} Var(X_{i})+\sum_{i\neq j} Cov(X_{i},X_{j})$\\
...
Import properties of $\rho: -1 \leq \rho \leq 1$